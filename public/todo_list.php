    ...
    if(is_get_request() && isset($_GET['id']))
    {
        ...
        <div style="margin-top:50px; margin-left: 20px;">
            <?php if($list_access == 2){ echo '
                ...
                ';} if(user_has_list_by_ids($con, $_SESSION['id'], $_GET['id'])){
                echo '<a class="btn color-0 back-color-4 border-color-4" href="' . url_for('list_access.php?list_id='.$_GET['id']) . '" style="width: 150px; height: 50px; position:absolute; right: 20px;"><p style="margin-top:5px">Manage Access</p></a>
            ';}?>
        </div>
